"""Stop-predicate / wall-clock-deadline tests for SwCpDispatcher."""
...
def test_stop_predicate_breaks_after_first_step() -> None:
    ...
    spec = AlgSpec(
        instance=instance,
        option=SwCpOption(cp_tl_seconds=0.5, unfixed_batch_count=2),
        ref_solution=seed,
