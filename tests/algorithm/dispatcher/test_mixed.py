...
def test_build_dispatch_seed_schedule_job_wise_feasible() -> None:
    """_build_dispatch_seed_schedule(coarsened, factor, job_wise) must return a feasible schedule."""
    from ffc_ddw_sum_et.algorithm.coarsen_solve_reconstruct import (
        _build_dispatch_seed_schedule,
    )

    instance = _make_tiny_instance()
    schedule = _build_dispatch_seed_schedule(instance, 1, "job_wise")
...
def test_build_dispatch_seed_schedule_mixed_feasible() -> None:
    ...
    instance = _make_tiny_instance()
    schedule = _build_dispatch_seed_schedule(instance, 1, "mixed")
...
def test_mixed_seed_obj_le_job_wise_seed_obj() -> None:
    ...
    instance = _make_tiny_instance()
    sch_jw = _build_dispatch_seed_schedule(instance, 1, "job_wise")
    sch_mixed = _build_dispatch_seed_schedule(instance, 1, "mixed")
