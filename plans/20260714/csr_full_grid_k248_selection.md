...
> 선행: `plans/20260714/coarse_exact_higher_k_validation.md`
...
- 선행 게이트: `plans/20260714/coarse_exact_higher_k_validation.md`
  (K-sweep validation, warning/crash 0, §"결과 (실행 후)").
- 근본 수정: `plans/20260714/cpsat_reconstruct_coarse_et_gap.md`
