...
`plans/20260705/sw_cp_tl_policy_investigation.md` **§3.3**, with artifacts under
...
other artifacts) or a `plans/20260707/` companion; a Markdown file is enough. If
...
- Coefficient results: `plans/20260705/sw_cp_tl_policy_investigation.md` §3.3;
