...
- Plan file location: per `feedback_plan_location`, once approved this plan should be moved to `plans/20260420/mcf-preemptive-gantt.md` in-repo before implementation starts.
