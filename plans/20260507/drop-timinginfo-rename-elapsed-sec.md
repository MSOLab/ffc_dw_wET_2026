...
- `plans/20260507/cpsat_adapter.md` — `TimingInfo(wall_ms=...)` 표기를 제거하고 후속 정리에 대한 노트 추가
- `plans/20260507/cpsat_obj_log_callbacks.md` — `elapsed_ms`, `* 1000.0`, `/ 1000.0` 표기를 `elapsed_sec` 기반으로 일괄 갱신
- `plans/20260427/neh-cp-lift-to-algorithm.md` — `ProgressLogEntry.elapsed_ms (× 1000)` 및 `record.timing.wall_ms / 1000` 표기를 `elapsed_sec` + 컨트롤러 측정 기반으로 정정
