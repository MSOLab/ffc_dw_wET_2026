...
RUNS: list[tuple[int, str, str, str, str, str, str]] = [
    (
        1,
        "20260429T233115_006438",
        "20260429",
        "metadata/20260429/20260429_config.yaml",
        "e792136",
        "mso02",
        "full",
    ),
    ...
    (
        3,
        "20260501T162650_028232",
        "20260501",
        "metadata/20260501/20260501_mcf_lb_then_neh_cp_config.yaml",
        "c675c1a",
        "mso02",
        "full",
    ),
    (
        4,
        "20260502T002742_596323",
        "20260501",
        "metadata/20260501/mcf_lb_init_19_config.yaml",
        "9e74acc",
        "mso02",
        "full",
    ),
    (
        5,
        "20260502T025451_273045",
        "20260501",
        "metadata/20260501/mcf_lb_init_20_config.yaml",
        "f31fc87",
        "mso02",
        "full",
    ),
    (
        6,
        "20260502T032313_670203",
        "20260501",
        "metadata/20260501/mcf_lb_init_21_config.yaml",
        "c43f87b",
        "mso02",
        "full",
    ),
    ...
    (
        8,
        "20260502T133412_116270",
        "20260502",
        "metadata/20260502/mcf_lb_init_22_config.yaml",
        "8304421",
        "mso02",
        "full",
    ),
    ...
    (
        10,
        "20260502T165007_640181",
        "20260502",
        "metadata/20260502/mcf_lb_init_23_config.yaml",
        "4f7fb0f",
        "mso02",
        "full",
    ),
    ...
    (
        14,
        "20260503T170549_147724",
        "20260503",
        "metadata/20260503/mcf_lb_init_25_config.yaml",
        "5c4920a",
        "mso02",
        "full",
    ),
    ...
    (
        16,
        "20260503T181635_000784",
        "20260503",
        "metadata/20260503/mcf_lb_init_26_config.yaml",
        "725a912",
        "mso02",
        "full",
    ),
    (
        17,
        "20260503T191906_135722",
        "20260503",
        "metadata/20260503/mcf_lb_init_27_config.yaml",
        "c4a790f",
        "mso02",
        "full",
    ),
    (
        18,
        "20260503T215803_006004",
        "20260503",
        "metadata/20260503/mcf_lb_init_28_config.yaml",
        "33cce02",
        "mso02",
        "full",
    ),
    (
        19,
        "20260503T230126_683476",
        "20260503",
        "metadata/20260503/mcf_lb_init_29_config.yaml",
        "f89ba73",
        "mso02",
        "full",
    ),
    (
        20,
        "20260504T003732_433340",
        "20260503",
        "metadata/20260503/mcf_lb_init_30_config.yaml",
        "9df77f8",
        "mso02",
        "full",
    ),
    (
        21,
        "20260504T004917_785558",
        "20260503",
        "metadata/20260503/mcf_lb_only_config.yaml",
        "3d546da",
        "mso02",
        "full",
    ),
    (
        22,
        "20260504T010002_965646",
        "20260503",
        "metadata/20260503/mcf_lb_init_31_config.yaml",
        "3d07d20",
        "mso02",
        "full",
    ),
    ...
    (
        27,
        "20260504T032732_697925",
        "20260503",
        "metadata/20260503/mcf_lb_init_32_config.yaml",
        "b090f84",
        "mso02",
        "full",
    ),
    (
        28,
        "20260504T082749_666067",
        "20260504",
        "metadata/20260504/mcf_lb_init_33_config.yaml",
        "1abc4f4",
        "mso02",
        "full",
    ),
    (
        29,
        "20260504T093058_016949",
        "20260504",
        "metadata/20260504/mcf_lb_init_34_config.yaml",
        "bff5eac",
        "mso02",
        "full",
    ),
    ...
    (
        34,
        "20260505T102202_582058",
        "20260505",
        "metadata/20260505/mcf_lb_init_37_config.yaml",
        "0a8a9b0",
        "mso02",
        "full",
    ),
    ...
    (
        36,
        "20260505T192009_887337",
        "20260505",
        "metadata/20260505/mcf_lb_init_38_config.yaml",
        "af944e3",
        "mso02",
        "full",
    ),
