...
fig1.suptitle(
    f"bs=15 vs bs=20: Is Larger Always Better? ({prefix})", fontsize=16, y=0.98
)
...
ax1a.axvline(
    x=0, color="red", linestyle="--", linewidth=2, label="threshold (no difference)"
)
ax1a.axvline(
    x=diff_15vs20.mean(),
    color="blue",
...
plt.tight_layout()
fig1.savefig(
    ANALYSIS_DIR / f"{prefix}_evidence_15vs20.png", dpi=200, bbox_inches="tight"
)
plt.close(fig1)
