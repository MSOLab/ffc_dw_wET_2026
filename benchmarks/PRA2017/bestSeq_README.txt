...
The first number is row number of the InstanceNameLarge.txt file. That row indicates the instance name for the instances folder
...
After this information we have one row per stage indicating the job order (the order in which jobs have been launched to the stage). Remind that jobs are assigned to machines using the FAM Rule.